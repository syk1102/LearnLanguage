from machine_supervisor import MachineSupervisor
__author__ = 'Se Yeon'
...
class LexicalAnalyzer:
    ...
    def process_file(self):
        source_file = open('Input/worstcase.p', 'r')
        self.line_num = 1
    ...
    def get_symbol_table(self):
        '''Reverses the symbol table which was {token_type : attribute}'''
        reverse_symbol_table = {}
        for k,v in self.symbol_table.items():
            # key is the attribute value of the ID
            reverse_symbol_table[v] = k
